...
//     {
//       path: '',
//       component: LandingPageComponent, // Assuming LandingPageComponent is correctly named
//     },
//     {
//         path: 'choose-account',
//         loadComponent: () =>
//           import('./choose-account/choose-account.component').then((m) => m.ChooseAccountComponent),
//     },
//     {
//       path: 'register',
//       loadComponent: () =>
...
//       },
//       { path: 'logout', loadComponent: () => import('./login/login.component').then((m) => m.LoginComponent) },
//     ],
//     },
//   ];
